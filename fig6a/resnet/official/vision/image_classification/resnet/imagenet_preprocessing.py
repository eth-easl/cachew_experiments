...
#DATASET = "ImageNet-Test" # dataset with only 4 ImageNet images

_SHUFFLE_BUFFER = 10000
#_SHUFFLE_BUFFER = int(0.4 * NUM_IMAGES['train'])
...
# _RESIZE_MIN is the lower bound for the smallest side of the image for aspect-preserving
...
def process_record_dataset(dataset,
  ...
  Args:
    ...
    tf_data_experimental_slack: Whether to enable tf.data's `experimental_slack`
      option.
    dataset_repeat: Applies a dataset.repeat() only if True.
